...
class EelKinematicsModel(csdl.Model):
    ...
    def define(self):
        ...
        # time_steps_normalized is the normalized time vector, from 0 to num_period
        # t_bar = t/T, dt_actual = dt_bar * T, T = 1/f, dt_actual = dt_bar/f
        # A = sin(2*pi*f*t)=sin(2*pi*f*t_bar*T), since T = 1/f, A = sin(2*pi*t_bar), this is used in compute_swimming_fish_kinematics

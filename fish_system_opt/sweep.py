...
def run_fish_sim(num_pts_L, num_pts_R,num_time_steps, v_x_val, tail_frequency_val, amp_max, num_period, run_opt=False, del_sim=False,problem_name='kin_opt'):
    ...
    ##############################################
    lower = 0.2
    fish_system_model.add_design_variable('tail_frequency',upper=lower*2,lower=lower*0.8)
    fish_system_model.add_design_variable('amplitude_max',upper=lower*2,lower=lower*0.4)
    # add objective
...
run_opt = False
v_x_val = 0.3
problem_name = 'kin_opt_08_22_3D_03'
thrust, avg_C_T, simulator = run_fish_sim(num_pts_L=41, num_pts_R=5,num_time_steps=70,

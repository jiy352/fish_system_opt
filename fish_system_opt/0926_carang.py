...
def run_fish_sim(num_pts_L, num_pts_R,num_time_steps, v_x_val, tail_frequency_val, amp_max, num_period, run_opt=False, del_sim=False,problem_name='kin_opt',lower=0.1):
    ...
    fish_system_model.add_design_variable('tail_frequency',upper=lower*6,lower=lower)
    fish_system_model.add_design_variable('amplitude_max',upper=lower*4,lower=lower*0.1)
    # add objective
...
if v_x_val == .2:
    ...
    thrust, avg_C_T, simulator = run_fish_sim(num_pts_L=41, num_pts_R=5,num_time_steps=70,
                 v_x_val=v_x_val, tail_frequency_val=.26, amp_max=0.2, 
    ...
    thrust, avg_C_T, simulator = run_fish_sim(num_pts_L=41, num_pts_R=5,num_time_steps=70,
                v_x_val=v_x_val, tail_frequency_val=.51, amp_max=0.2, 
                #  v_x_val=v_x_val, tail_frequency_val=0.353, amp_max=0.2, 
    ...
    thrust, avg_C_T, simulator = run_fish_sim(num_pts_L=41, num_pts_R=5,num_time_steps=70,
                v_x_val=v_x_val, tail_frequency_val=1.232, amp_max=0.2, 
                #  v_x_val=v_x_val, tail_frequency_val=0.353, amp_max=0.2, 

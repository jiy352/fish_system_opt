...
for i in range(len(v_x_list)):
    ...
    fish_mp_model.create_input(f'x1_{i}', val=x1_val)
    fish_mp_model.create_input(f'h1_{i}', val=h1_val)
    fish_mp_model.create_input(f'x2_{i}', val=x2_val)
    fish_mp_model.create_input(f'h2_{i}', val=h2_val)
    fish_mp_model.create_input(f'tail_width_{i}', val=tail_width_val)
...
for i in range(len(v_x_list)):
    ...
    fish_mp_model.connect(f'x1_{i}', f'fish_system_model_{i}'+'.x1')
    fish_mp_model.connect(f'h1_{i}', f'fish_system_model_{i}'+'.h1')
    fish_mp_model.connect(f'x2_{i}', f'fish_system_model_{i}'+'.x2')
    fish_mp_model.connect(f'h2_{i}', f'fish_system_model_{i}'+'.h2')
    fish_mp_model.connect(f'tail_width_{i}', f'fish_system_model_{i}'+'.tail_width')

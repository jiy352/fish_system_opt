...
def run_fish_sim(num_pts_L, num_pts_R,num_time_steps, v_x_val, tail_frequency_val, num_period, run_opt=False, del_sim=False,turn=False,problem_name='kin_opt'):
    #########################################
...
run_opt = True
problem_name = 'full_opt_1202_sp_bspline_mp_new_02'
v_x_list = np.array([0.3, 0.6, 0.9, 0.3])
turn_list = np.array([False,False, False, True])
tail_frequency_list = np.array([0.5458, 0.9899, 1.409, 0.225885])
...
a_1 = -0.08
a_2 = 0.16
amp_cp_vals =  (a_0 + a_1 * x + a_2 * x**2 ) #* 0.3

ratio_val = amp_cp_vals[1:]/amp_cp_vals[:-1]
ratio_0 = fish_mp_model.create_input('ratio_0',val=ratio_val[1:]*1.0293)
ratio_1 = fish_mp_model.create_input('ratio_1',val=ratio_val[1:]*1.0318)
ratio_2 = fish_mp_model.create_input('ratio_2',val=ratio_val[1:]*1.0333)

amplitude_scalar_var_list = [0.5481, 0.54725, 0.5473]

amplitude_scalar_0 = fish_mp_model.create_input('amplitude_scalar_0',val=amplitude_scalar_var_list[0])

amplitude_cp = fish_mp_model.create_output('eel_amplitude_cp_0', shape=(num_cp_amp,))
pos_0 = fish_mp_model.create_input('eel_amplitude_cp_0_0',val=amp_cp_vals[0]) * amplitude_scalar_0
pos_1 = fish_mp_model.create_input('eel_amplitude_cp_0_1',val=amp_cp_vals[1]) * amplitude_scalar_0
amplitude_cp[0] = pos_0 * amplitude_scalar_0
amplitude_cp[1] = pos_1 * amplitude_scalar_0
amplitude_cp[2] = pos_1 * ratio_0[0] * amplitude_scalar_0
amplitude_cp[3] = pos_1 * ratio_0[0] * ratio_0[1] * amplitude_scalar_0
amplitude_cp[4] = pos_1 * ratio_0[0] * ratio_0[1] * ratio_0[2] * amplitude_scalar_0
amplitude_cp[5] = pos_1 * ratio_0[0] * ratio_0[1] * ratio_0[2] * ratio_0[3] * amplitude_scalar_0

amplitude_scalar_1 = fish_mp_model.create_input('amplitude_scalar_1',val=amplitude_scalar_var_list[1])
amplitude_cp = fish_mp_model.create_output('eel_amplitude_cp_1', shape=(num_cp_amp,))
pos_0 = fish_mp_model.create_input('eel_amplitude_cp_1_0',val=amp_cp_vals[0])* amplitude_scalar_1
pos_1 = fish_mp_model.create_input('eel_amplitude_cp_1_1',val=amp_cp_vals[1])* amplitude_scalar_1
amplitude_cp[0] = pos_0 * amplitude_scalar_1
amplitude_cp[1] = pos_1 * amplitude_scalar_1
amplitude_cp[2] = pos_1 * ratio_1[0] * amplitude_scalar_1
amplitude_cp[3] = pos_1 * ratio_1[0] * ratio_1[1] * amplitude_scalar_1
amplitude_cp[4] = pos_1 * ratio_1[0] * ratio_1[1] * ratio_1[2] * amplitude_scalar_1
amplitude_cp[5] = pos_1 * ratio_1[0] * ratio_1[1] * ratio_1[2] * ratio_1[3] * amplitude_scalar_1

amplitude_scalar_2 = fish_mp_model.create_input('amplitude_scalar_2',val=amplitude_scalar_var_list[2])
amplitude_cp = fish_mp_model.create_output('eel_amplitude_cp_2', shape=(num_cp_amp,))
pos_0 = fish_mp_model.create_input('eel_amplitude_cp_2_0',val=amp_cp_vals[0])* amplitude_scalar_2
pos_1 = fish_mp_model.create_input('eel_amplitude_cp_2_1',val=amp_cp_vals[1])* amplitude_scalar_2
amplitude_cp[0] = pos_0 * amplitude_scalar_2
amplitude_cp[1] = pos_1 * amplitude_scalar_2
amplitude_cp[2] = pos_1 * ratio_2[0] * amplitude_scalar_2
amplitude_cp[3] = pos_1 * ratio_2[0] * ratio_2[1] * amplitude_scalar_2
amplitude_cp[4] = pos_1 * ratio_2[0] * ratio_2[1] * ratio_2[2] * amplitude_scalar_2
amplitude_cp[5] = pos_1 * ratio_2[0] * ratio_2[1] * ratio_2[2] * ratio_2[3] * amplitude_scalar_2
...
for i in range(len(v_x_list)):
    ...
    if turn == False:
        ...
        fish_mp_model.add_design_variable(f'amplitude_scalar_{i}',upper=1.0,lower=0.2)
...
# combined_objective = sum_power + 0.25 * R_sq
# combined_objective = sum_power + 0.1 * R_sq
combined_objective = sum_power + 0.2 * R_sq

...
if run_opt == True:
    ...
    fish_system_model.add_objective('thrust_coeff_avr')
    #########################################
...
#print 
print('###################  values in efficiency model ######################')
print('efficiency is',simulator['efficiency'])
print('v_x is',simulator['v_x'])
print('panel_thrust_power_x is',simulator['panel_thrust_power_x'])
print('panel_thrust_power_y is',simulator['panel_thrust_power_y'])
print('panel_thrust_power_z is',simulator['panel_thrust_power_z'])

print()
print('thrust power is',simulator['thrust_power'])
